...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/configuracoes.o \
	${OBJECTDIR}/estatisticas.o \
	${OBJECTDIR}/ghost.o \
	${OBJECTDIR}/jogo.o \
	${OBJECTDIR}/main.o \
	${OBJECTDIR}/partida.o \
	${OBJECTDIR}/simulacao.o \
	${OBJECTDIR}/still_lifes.o \
...
${OBJECTDIR}/configuracoes.o: configuracoes.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/configuracoes.o configuracoes.c

${OBJECTDIR}/estatisticas.o: estatisticas.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/estatisticas.o estatisticas.c

${OBJECTDIR}/ghost.o: ghost.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
${OBJECTDIR}/still_lifes.o: still_lifes.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/still_lifes.o still_lifes.c
